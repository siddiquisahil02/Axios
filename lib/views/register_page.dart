...
import 'package:society_manager/models/city_model.dart';
import 'package:society_manager/models/residence-uid_model.dart';
import 'package:society_manager/utils/ui_constants.dart';
import 'package:society_manager/utils/validators.dart';
              ...
              if(state is RegisterLoading){
                ...
                Future.delayed(Duration.zero,()async{
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('Welcome ${auth.currentUser?.displayName.toString()}...!'))
                  );
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: textInputDeco(data: const Icon(CupertinoIcons.person_alt_circle_fill)),
                  ),
                  ...
                  TextFormField(
                    ...
                    decoration: textInputDeco(data: const Icon(CupertinoIcons.mail_solid)),
                  ),
                  const SizedBox(height: 20),
                  ...
                  TextFormField(
                    ...
                    decoration: textInputDeco(data: const Icon(CupertinoIcons.padlock_solid)),
                  ),
                  const SizedBox(height: 20),
                  ...
                  if(residence!=null)...[
                    ...
                    TextFormField(
                      ...
                      decoration: textInputDeco(data: const Icon(CupertinoIcons.house_fill)),
                    ),
                    const SizedBox(height: 20),
                  ],
